...
# file_list = glob("../../games/dbsz/base_files/icon/*.png", recursive=True)
with open("../../games/dbsz/base_files/icon/config.json", "rt", encoding="utf-8") as config_file:
    icon_config = json.loads(config_file.read())
with open("../../games/dbsz/base_files/config.json", "rt", encoding="utf-8") as config_file:
