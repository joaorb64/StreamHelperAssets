...
# file_list = glob("../../games/invs/full/*.png", recursive=True)
with open("../../games/invs/full/config.json", "rt", encoding="utf-8") as config_file:
    full_config = json.loads(config_file.read())
with open("../../games/invs/base_files/config.json", "rt", encoding="utf-8") as config_file:
...
for character_name in main_config["character_to_codename"].keys():
    ...
    image_filename = f"../../games/invs/full/{full_config['prefix']}{codename}{full_config['postfix']}0.png"
...
with open("../../games/invs/full/config.json", "wt", encoding="utf-8") as config_file:
