...
for character_name in main_config["character_to_codename"].keys():
    ...
    for i in range(5):
        ...
        image_filename = f"../../games/mtfs/stand/{stand_config['prefix']}{codename}{stand_config['postfix']}{i:01}.png"
        ...
        image_filename = f"../../games/mtfs/full/{full_config['prefix']}{codename}{full_config['postfix']}{i:01}.png"
        if os.path.isfile(image_filename):
            image = Image.open(image_filename, "r").convert("RGBA")
            height = image.height
...
with open("../../games/mtfs/stand/config.json", "wt", encoding="utf-8") as config_file:
    config_file.write(json.dumps(stand_config, indent=2))
with open("../../games/mtfs/full/config.json", "wt", encoding="utf-8") as config_file:
