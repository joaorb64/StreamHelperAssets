...
info_url = "https://wiki.gbl.gg/w/Asuka_120_LimitOver"
base_url = f"{info_url}/Asuka_Honda"
...
def get_portrait(character_name, page_link):
    ...
    for tag in character_page_links_tag_list:
        link = tag["href"]
        if ("Portrait" in link) and ("File:A120LO" in link):
...
def get_all_links():
    ...
    for character_tag in character_icons_table:
        ...
        for href_tag in href_tags:
            if "Asuka 120 LimitOver" not in href_tag["title"]:
