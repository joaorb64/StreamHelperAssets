...
info_url = "https://wiki.gbl.gg/w/Punch_Planet"
base_url = f"{info_url}"
...
def get_icon_from_character_name(character_name):
    ...
    for tag in list_img_tags:
        try:
            ...
            alt_text = None
        if (character_name in alt_text) and ("closeup" in tag["src"]):
...
def get_all_links():
    ...
    for character_tag in character_icons_table:
        ...
        for href_tag in href_tags:
            if "Punch Planet" not in href_tag["title"]:
