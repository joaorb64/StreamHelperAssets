...
info_url = "https://wiki.gbl.gg/w/Tough_Love_Arena"
base_url = f"{info_url}/Noodle"
...
def get_portrait(character_name, page_link):
    ...
    for tag in character_page_links_tag_list:
        link = tag["href"]
        if ("portrait" in link) and ("File:TLA" in link):
...
def get_all_links():
    ...
    for character_tag in character_icons_table:
        ...
        for href_tag in href_tags:
            if "Tough Love Arena" not in href_tag["title"]:
